...
const TodaysGuidance = () => {
  ...
  return (
    <MainLayout title="Today's Guidance" breadcrumbs={['Home', 'Daily Guidance']} showHeader={true} disableContentPadding={false}>
      <div {...bind} className="min-h-screen bg-[#0B0F1A] pb-20">
        ...
        <div className="max-w-[1440px] mx-auto px-2 md:px-8 pt-6 md:pt-10">
